...
#mtext(text=spnames$LongName[ind],side=2,cex=0.2, padj=1)
...
plot(Z.rot[,1],Z.rot[,2], ylab="Trend 2", xlab="Trend 1", xlim=c(-1.3,1.2), ylim=c(-.6,.4))
textxy(Z.rot[,1],Z.rot[,2], sp.names$spp, cex= 0.5, offset=0.6)
abline(v=0)
abline(h=0)
