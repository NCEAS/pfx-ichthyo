...
#Z.rot.plot=NA
Z.dat=data.frame(cbind(sp.names, Z.rot))
names(Z.dat)=c('Species', 'LongName','ShortName','Trend1','Trend2')
...
ggplot(Z.rot.plot, aes(Trend1, Trend2)) +
 ...
 geom_text_repel(aes(Trend1,Trend2, alpha=log(meanAbund), label=Species), family="Helvetica") +
  theme_sleek() +
  scale_colour_brewer(type="qual", palette=3)+
  coord_cartesian(xlim=c(-1.5,1.5), ylim=c(-.6,.4))
#dev.off()
