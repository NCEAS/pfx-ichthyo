...
ggplot(Z.rot.plot, aes(Trend1, Trend2)) +
 ...
 geom_text_repel(aes(Trend1,Trend2, alpha=log(meanAbund), label=Hab.short), family="Helvetica") +
  theme_sleek() +
...
ggplot(Z.rot.plot, aes(Trend1, Trend2)) +
 ...
 geom_hline(yintercept=c(-0.2,0.2), colour="grey80", size=2) +
 geom_point(aes(color=H.cluster)) +
 geom_text_repel(aes(Trend1,Trend2, alpha=log(meanAbund), label=shelf.slope), family="Helvetica") +
  theme_sleek() +
  scale_colour_brewer(type="qual", palette=3)+
  coord_cartesian(xlim=c(-1,1), ylim=c(-.6,.4))
#dev.off()
...
ggplot(Z.rot.plot, aes(Trend1, Trend2)) +
 ...
 geom_hline(yintercept=c(-0.2,0.2), colour="grey80", size=2) +
 geom_point(aes(color=H.cluster)) +
 geom_text_repel(aes(Trend1,Trend2, alpha=log(meanAbund), label=Spawn.short), family="Helvetica") +
  theme_sleek() +
  scale_colour_brewer(type="qual", palette=3)+
  coord_cartesian(xlim=c(-1,1), ylim=c(-.6,.4))
...
ggplot(Z.rot.plot, aes(Trend1, Trend2)) +
 ...
 geom_hline(yintercept=c(-0.2,0.2), colour="grey80", size=2) +
 geom_point(aes(color=H.cluster)) +
 geom_text_repel(aes(Trend1,Trend2, alpha=log(meanAbund), label=Dur.short), family="Helvetica") +
  theme_sleek() +
  scale_colour_brewer(type="qual", palette=3)+
  coord_cartesian(xlim=c(-1,1), ylim=c(-.6,.4))
...
ggplot(Z.rot.plot, aes(Trend1, Trend2)) +
 ...
 geom_hline(yintercept=c(-0.2,0.2), colour="grey80", size=2) +
 geom_point(aes(color=H.cluster)) +
 geom_text_repel(aes(Trend1,Trend2, alpha=log(meanAbund), label=Lat), family="Helvetica") +
  theme_sleek() +
  scale_colour_brewer(type="qual", palette=3)+
  coord_cartesian(xlim=c(-1,1), ylim=c(-.6,.4))
